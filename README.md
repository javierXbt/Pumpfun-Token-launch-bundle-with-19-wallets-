# Pumpfun-Token-launch-bundle-with-19-wallets-
...
🖊️Generate Vanity Token named contracts
🖊️MultiProject Manageable, you can manage previous projects just with the token address
🖊️Generate 19 Wallets , fund them using Spender Wallet, to Keep the Bubbles away
🖊️Create and Buy using Dev Wallet, Devwallet buy configurable in .env file.
🖊️Manage all 20wallets, its tokens, solana balances
Recover Solana from All Wallets.
🖊️Dump on Raydium on Launch
🖊️Boost Tokens using the integrated PFBooster
